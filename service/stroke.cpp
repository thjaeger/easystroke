...
void Stroke2::addPoint(double x, double y) {
    this->p.emplace_back(x, y);
}
 ...
 */
double Stroke2::compare(const Stroke2& a, const Stroke2& b, int *path_x, int *path_y) {
