...
#ifndef _GTKMM_CELLRENDERERTK_H
#define _GTKMM_CELLRENDERERTK_H
...
namespace Gtk
{ class CellRendererTK_Class; } // namespace Gtk
namespace Gtk
{
 ...
 *
 * Gtk::CellRendererTK displays a keyboard accelerator 
...
class CellRendererTK : public CellRendererText
{
  public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  typedef CellRendererTK CppObjectType;
  typedef CellRendererTK_Class CppClassType;
  typedef GtkCellRendererTK BaseObjectType;
  typedef GtkCellRendererTKClass BaseClassType;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */

  virtual ~CellRendererTK();

#ifndef DOXYGEN_SHOULD_SKIP_THIS

private:
  friend class CellRendererTK_Class;
  static CppClassType cellrendereraccel_class_;

  // noncopyable
  CellRendererTK(const CellRendererTK&);
  CellRendererTK& operator=(const CellRendererTK&);

protected:
  explicit CellRendererTK(const Glib::ConstructParams& construct_params);
  explicit CellRendererTK(GtkCellRendererTK* castitem);
...
public:
  ...
  GtkCellRendererTK*       gobj()       { return reinterpret_cast<GtkCellRendererTK*>(gobject_); }

  ///Provides access to the underlying C GtkObject.
  const GtkCellRendererTK* gobj() const { return reinterpret_cast<GtkCellRendererTK*>(gobject_); }
...
/** The hardware keycode of the accelerator.
  ...
  Glib::PropertyProxy<GtkCellRendererTKMode> property_cell_mode() ;
#endif //#GLIBMM_PROPERTIES_ENABLED
...
namespace Glib
{
   ...
   *
   * @relates Gtk::CellRendererTK
   */
  Gtk::CellRendererTK* wrap(GtkCellRendererTK* object, bool take_copy = false);
} //namespace Glib
